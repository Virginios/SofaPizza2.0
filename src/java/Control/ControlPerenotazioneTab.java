 ...
 * @author Valerio
 */
@WebServlet(name = "ControlPerenotazioneTab", urlPatterns = {"/ControlPerenotazioneTab"})
public class ControlPerenotazioneTab extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControlPerenotazioneTab</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControlPerenotazioneTab at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
