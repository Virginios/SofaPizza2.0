<%-- 
    Document   : RegErrorPizzeria
    Created on : 23-feb-2017, 18.17.30
    Author     : Valerio
--%>
        ...
        <div id="tabella">
            <table cellspacing="6">
                ...
                <tr>
                    ...
                    <td>
                        <input class="input" id="PartitaIva" name="partitaIva" type="text" required  pattern="[A-Za-z0-9\s]{3,45}" 
                                   placeholder=" partita iva" title="via (dai 3 ai 45 caratteri)"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <span id="errori">la partita iva e' gia' presente</span>
                    </td>
                </tr>
                <tr>
                    <td><b>Telefono</b></td>
                ...
                <tr id ="contReg">
                    <td></td>
                    <td>
                        <input name="Submit" id="registrati"  type="submit" value="Avanti">
                    </td>
                </tr>
                </tbody>
            </table>
