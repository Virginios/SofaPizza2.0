...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/RegistrazioneCliente.css" type="text/css">
            ...
            <table cellspacing="6">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="input" id="Nome" name="nome" type="text"
                                   placeholder=" Nome" pattern="[A-Za-z\s]{3,45}" title="Nome (dai 3 ai 45 caratteri)" required/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="input" id="Cognome" name="cognome" type="text"
                                   placeholder=" Cognome" pattern="[A-Za-z\s]{3,45}" title="Nome (dai 3 ai 45 caratteri)" required/>
                        </td>
                    </tr><tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>		 
                            <input class="input" id="Giorno" style="width: 30px" type="text" name="giorno" required/> /
                            <input class="input" id="Mese" style="width: 30px" type="text" name="mese" required/> /
                            <input class="input" id="Anno" style="width: 50px" type="text" name="anno" required/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <tr>
                    <td><b>Indirizzo</b></td>
                    <td>
                        <input class="input" id="Indirizzo" name="indirizzo" 
                               type="text" placeholder="Indirizzo"pattern="[A-Za-z0-9\s]"
                               title="Indirizzo di residenza/>
                               </td>
                               </tr>
                               <tr>
                               <td>
                               <span class="errore" id="erroreIndirizzo">il campo non puo essere lasciato vuoto</span>
                    </td>
                </tr>
                <tr>
                    <td><b>Telefono</b></td>
                ...
                <tr>
                    <td><b>Password</b></td>
                    <td>
                        <input  onblur="checkpassword"  class="input" id="Password" name="password" type="password" placeholder="Password" pattern="[^\s]{4,8}"
                                title="Password (dai 6 ai 18 caratteri alfanumerici e speciali, spazi esclusi)" required/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr id ="contReg">
                    <td></td>
                    <td>
                        <input name="Submit" id="registrati"  type="button" value="Registrati" onclick="controllo(); return false" />
                    </td>
                </tr>
                </tbody>
            </table>
