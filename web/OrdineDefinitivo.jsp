...
<%=pizze.get(i).getIngredienti()%>                                </pre>
                        ...
                        <td width="20" height="30"><button class="bottone1" id="<%=pizze.get(i).getPrezzo()%>" OnClick="add('<%="#" + pizze.get(i).getIdpizza()%>', this.id);">
                                <span class="aggiungielemento">+</span>
                            </button>
                            <button class="bottone1" id="<%=pizze.get(i).getPrezzo()%>" OnClick="decr('<%="#" + pizze.get(i).getIdpizza()%>', this.id);">
                                <span class="aggiungielemento">-</span>
                            </button></td>
                    </tr>
                    <%}%>
