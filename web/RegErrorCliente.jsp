    ...
    <form name="modulo" id="form" action="/RegistrazioneCliente" method="post" onSubmit="return controlForm()">
        <div id="tabella">
            <table cellspacing="6">
                    ...
                    <td>
                        <input class="input" id="Email" name="email" type="text" required 
                               ...
                               title="Indirizzo di posta elettronica" />
                                        ...
                                        <span class="errore" id="erroreMail" style="display: block;color: red">la mail gia' esiste</span>
                ...
                <tr>
                    <td>
                        <span class="errore" id="erroreConfermaPassword" style="display: block;color: red">le password non corrispondono</span>
                    </td>
                </tr>
                <tr id ="contReg">
                    <td></td>
